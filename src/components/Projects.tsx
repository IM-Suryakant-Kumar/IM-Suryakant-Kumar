				...
				{projects.map((project) => (
					...
					>
						...
						<div className="w-full flex justify-between mt-4">
							<a
								className="inline-block bg-orange-400 hover:bg-orange-600 text-primary font-bold px-4 py-1 text-sm rounded-lg ease-in-out duration-300"
								href={project.live}
								target="_blank"
							>
								Live
							...
							<a
								className="inline-block text-orange-400 hover:text-orange-600 font-bold border-2 border-orange-400 hover:border-orange-600 px-4 py-1 text-sm rounded-lg ease-in-out duration-300"
								href={project.github}
								target="_blank"
							>
								Code
